class VRButton {
	...
	showEnterVR(button) {
		...
		button.style.width = '100px'; // Modify button width
		button.style.height = '50px'; // Modify button height
		button.style.borderRadius = '25px'; // Make the button more rounded
	...
	stylizeElement(element, active = true, fontSize = 13, ignorePadding = false) {
		...
		element.style.borderRadius = '30px'; // Apply rounded corners
